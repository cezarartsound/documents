...
#define VGA_get16bpp_color(r, g, b) (((255) << 24) | (((r*255)/100) << 16) | (((g*255)/100) << 8) | ((b*255)/100))
...
// define override for 32bpp
#define COLOR_WHITE 		VGA_get16bpp_color(100,100,100)
#define COLOR_BLACK 		VGA_get16bpp_color(0,0,0)
...
//#define VGA_get16bpp_color(r, g, b) (((r*31)/100)<<11) | (((g*63)/100)<<5) | //((b*31)/100) // use for 16bpp
...
void VGA_fill_rect(int x1,int y1, int x2, int y2, unsigned int color);
