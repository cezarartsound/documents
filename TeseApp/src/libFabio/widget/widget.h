...
void widget_init();
void widget_initall();// inicia o input e event
void widget_exit();
void widget_exitall();
...
W_List* w_button_addto(W_List** list, char*text , int font_size , int x, int y, int x1, int y1, void (*action)(void*), void * param); // nao desenha

W_List* w_label_add(char*text , int font_size , int x, int y,int color);
W_List* w_label_addto(W_List** list, char*text , int font_size , int x, int y,int color); // nao desenha
...
W_List* w_imagebutton_addto(W_List** list,char * image_name , int x, int y, int trans_color,void (*action)(void*), void * param); // nao desenha
